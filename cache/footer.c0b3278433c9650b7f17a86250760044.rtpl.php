...
<!-- jQuery sticky menu -->
<script src="/resources/store/js/owl.carousel.min.js"></script>
<script src="/resources/store/js/jquery.sticky.js"></script>

<!-- jQuery easing -->
<script src="/resources/store/js/jquery.easing.1.3.min.js"></script>

<!-- Main Script -->
<script src="/resources/store/js/main.js"></script>

<!-- Slider -->
<script type="text/javascript" src="/resources/store/js/bxslider.min.js"></script>
<script type="text/javascript" src="/resources/store/js/script.slider.js"></script>
</body>
</html>